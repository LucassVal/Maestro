...
class TerminalSoldier:
    ...
    def executar(self, comando: str, modo_seguro: bool = True) -> Dict:
        ...
        from src.agentes.passivos.proposta_acao_SRC_GL import PropostaAcao
        pa = PropostaAcao()
    ...
    def executar_final(self, proposta_id: str) -> Dict:
        ...
        if not os.path.exists(path):
            return {"erro": "Proposal not found"}
...
# Global instance
terminal_soldado_SRC_GL = TerminalSoldier()

if __name__ == "__main__":
    # Quick test
    res = terminal_soldado_SRC_GL.executar("whoami")
    print(res)
